...
func NewServiceInfo() *kitex.ServiceInfo {
	...
	methods := map[string]kitex.MethodInfo{
		...
		"ListVideo":    kitex.NewMethodInfo(listVideoHandler, newVideoServiceListVideoArgs, newVideoServiceListVideoResult, false),
	}
...
func listVideoHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	realArg := arg.(*video.VideoServiceListVideoArgs)
	realResult := result.(*video.VideoServiceListVideoResult)
	success, err := handler.(video.VideoService).ListVideo(ctx, realArg.Req)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func newVideoServiceListVideoArgs() interface{} {
	return video.NewVideoServiceListVideoArgs()
}

func newVideoServiceListVideoResult() interface{} {
	return video.NewVideoServiceListVideoResult()
}
...
func (p *kClient) PublishVideo(ctx context.Context, req *video.VideoPublishActionRequest) (r *video.VideoPublishActionResponse, err error) {
...
func (p *kClient) ListVideo(ctx context.Context, req *video.VideoPublishActionRequest) (r *video.VideoListResponse, err error) {
	var _args video.VideoServiceListVideoArgs
	_args.Req = req
	var _result video.VideoServiceListVideoResult

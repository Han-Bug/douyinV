...
type CommentService interface {
	...
	ListComment(ctx context.Context, req *CommentActionRequest) (r *CommentListResponse, err error)
}
...
func (p *CommentServiceClient) ListComment(ctx context.Context, req *CommentActionRequest) (r *CommentListResponse, err error) {
...
var CommentServiceListCommentArgs_Req_DEFAULT *CommentActionRequest

func (p *CommentServiceListCommentArgs) GetReq() (v *CommentActionRequest) {
	if !p.IsSetReq() {
		return CommentServiceListCommentArgs_Req_DEFAULT
	}
	return p.Req
}
func (p *CommentServiceListCommentArgs) SetReq(val *CommentActionRequest) {
	p.Req = val
}
...
func (p *CommentServiceListCommentArgs) Field1DeepEqual(src *CommentActionRequest) bool {

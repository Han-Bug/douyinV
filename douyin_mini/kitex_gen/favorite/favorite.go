...
func (p *FavoriteActionRequest) GetUserId() (v string) {
	return p.UserId
}
...
func (p *FavoriteActionRequest) SetUserId(val string) {
	p.UserId = val
}
...
type FavoriteActionResponse struct {
	BaseRep *BaseResp `thrift:"base_rep,1" frugal:"1,default,BaseResp" json:"base_rep"`
}
...
var FavoriteActionResponse_BaseRep_DEFAULT *BaseResp

func (p *FavoriteActionResponse) GetBaseRep() (v *BaseResp) {
	if !p.IsSetBaseRep() {
		return FavoriteActionResponse_BaseRep_DEFAULT
	}
	return p.BaseRep
}
func (p *FavoriteActionResponse) SetBaseRep(val *BaseResp) {
	p.BaseRep = val
}
...
func (p *FavoriteActionResponse) IsSetBaseRep() bool {
	return p.BaseRep != nil
}
...
func (p *FavoriteActionResponse) ReadField1(iprot thrift.TProtocol) error {
	p.BaseRep = NewBaseResp()
	if err := p.BaseRep.Read(iprot); err != nil {
		return err
	}
	return nil
}
...
func (p *FavoriteActionResponse) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("base_rep", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.BaseRep.Write(oprot); err != nil {
		return err
	}
	if err = oprot.WriteFieldEnd(); err != nil {
		goto WriteFieldEndError
...
func (p *FavoriteActionResponse) DeepEqual(ano *FavoriteActionResponse) bool {
	...
	if !p.Field1DeepEqual(ano.BaseRep) {
		return false
	}
	return true
}
...
type FavoriteService interface {
	...
	FavoriteList(ctx context.Context, req *FavoriteActionRequest) (r *FavoriteListResponse, err error)
}
...
func (p *FavoriteServiceClient) FavoriteList(ctx context.Context, req *FavoriteActionRequest) (r *FavoriteListResponse, err error) {
...
var FavoriteServiceFavoriteListArgs_Req_DEFAULT *FavoriteActionRequest

func (p *FavoriteServiceFavoriteListArgs) GetReq() (v *FavoriteActionRequest) {
	if !p.IsSetReq() {
		return FavoriteServiceFavoriteListArgs_Req_DEFAULT
	}
	return p.Req
}
func (p *FavoriteServiceFavoriteListArgs) SetReq(val *FavoriteActionRequest) {
	p.Req = val
}
...
func (p *FavoriteServiceFavoriteListArgs) Field1DeepEqual(src *FavoriteActionRequest) bool {

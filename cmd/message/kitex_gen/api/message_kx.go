...
type Msg struct {
	...
	CreateTime string `thrift:"create_time,5,required" frugal:"5,required,string" json:"create_time"`
}
...
func (p *Msg) GetCreateTime() (v string) {
	return p.CreateTime
}
func (p *Msg) SetId(val int64) {
	p.Id = val
}
...
func (p *Msg) SetCreateTime(val string) {
	p.CreateTime = val
}

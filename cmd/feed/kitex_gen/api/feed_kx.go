...
func (p *FeedFeedArgs) InitDefault() {
	*p = FeedFeedArgs{}
}
...
func (p *FeedFeedArgs) SetReq(val *FeedReq) {
	p.Req = val
}
...
func (p *FeedFeedArgs) DeepEqual(ano *FeedFeedArgs) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *FeedFeedArgs) Field1DeepEqual(src *FeedReq) bool {
...
func (p *FeedFeedResult) InitDefault() {
	*p = FeedFeedResult{}
}
...
func (p *FeedFeedResult) SetSuccess(x interface{}) {
...
func (p *FeedFeedResult) DeepEqual(ano *FeedFeedResult) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *FeedFeedResult) Field0DeepEqual(src *FeedResp) bool {

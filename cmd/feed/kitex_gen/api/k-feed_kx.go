...
func (p *FeedFeedArgs) FastRead(buf []byte) (int, error) {
	var err error
	var offset int
	var l int
	var fieldTypeId thrift.TType
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_FeedFeedArgs[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
ReadFieldEndError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field end error", p), err)
...
func (p *FeedFeedArgs) FastReadField1(buf []byte) (int, error) {
	offset := 0
...
// for compatibility
func (p *FeedFeedArgs) FastWrite(buf []byte) int {
	return 0
}

func (p *FeedFeedArgs) FastWriteNocopy(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
...
func (p *FeedFeedArgs) BLength() int {
	l := 0
...
func (p *FeedFeedArgs) fastWriteField1(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
...
func (p *FeedFeedArgs) field1Length() int {
	l := 0
...
func (p *FeedFeedResult) FastRead(buf []byte) (int, error) {
	var err error
	var offset int
	var l int
	var fieldTypeId thrift.TType
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_FeedFeedResult[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
ReadFieldEndError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field end error", p), err)
...
func (p *FeedFeedResult) FastReadField0(buf []byte) (int, error) {
	offset := 0
...
// for compatibility
func (p *FeedFeedResult) FastWrite(buf []byte) int {
	return 0
}

func (p *FeedFeedResult) FastWriteNocopy(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
...
func (p *FeedFeedResult) BLength() int {
	l := 0
...
func (p *FeedFeedResult) fastWriteField0(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	if p.IsSetSuccess() {
...
func (p *FeedFeedResult) field0Length() int {
	l := 0
	if p.IsSetSuccess() {
...
func (p *FeedFeedArgs) GetFirstArgument() interface{} {
	return p.Req
}

func (p *FeedFeedResult) GetResult() interface{} {
	return p.Success
}
